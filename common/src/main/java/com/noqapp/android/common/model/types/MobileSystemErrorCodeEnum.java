...
public enum MobileSystemErrorCodeEnum {
    ...
    JOIN_PRE_APPROVED_QUEUE_ONLY("3401", ALERT),
    JOINING_NOT_PRE_APPROVED_QUEUE("3402", ALERT),
    JOINING_QUEUE_PERMISSION_DENIED("3403", ALERT),
    SERVICE_AFTER_CLOSING_HOUR("3404", ALERT),
    SERVICED_TODAY("3405", ALERT),
    WAIT_UNTIL_SERVICE_BEGUN("3406", ALERT),
    ...
    ONE_ADDRESS_AT_LEAST("4071", ALERT),
    DEVICE_TIMEZONE_OFF("4080", INFO),
    ...
    PURCHASE_ORDER_NEGATIVE("4217", ALERT),
