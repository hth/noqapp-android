        ...
        if (cursor != null && cursor.getCount() > 0) {
            try {
                while (cursor.moveToNext()) {
                    ...
                    tokenAndQueue.setDisplayToken(cursor.getString(13));
                    tokenAndQueue.setQueueStatus(QueueStatusEnum.valueOf(cursor.getString(14)));
                    tokenAndQueue.setServiceEndTime(cursor.getString(15));
                    tokenAndQueue.setRatingCount(cursor.getInt(16));
                    tokenAndQueue.setAverageServiceTime(cursor.getInt(17));
                    tokenAndQueue.setHoursSaved(cursor.getInt(18));
                    tokenAndQueue.setCreateDate(cursor.getString(19));
                    tokenAndQueue.setBusinessType(cursor.getString(20) == null ? null : BusinessTypeEnum.valueOf(cursor.getString(20)));
                    tokenAndQueue.setGeoHash(cursor.getString(21));
                    tokenAndQueue.setTown(cursor.getString(22));
                    tokenAndQueue.setArea(cursor.getString(23));
                    tokenAndQueue.setDisplayImage(cursor.getString(24));
                    tokenAndQueue.setQueueUserId(cursor.getString(25));
                    tokenAndQueue.setPurchaseOrderState(PurchaseOrderStateEnum.valueOf(cursor.getString(26)));
                    tokenAndQueue.setTransactionId(cursor.getString(27));
                    tokenAndQueue.setTimeSlotMessage(cursor.getString(28));
            ...
            if (cursor != null && cursor.getCount() > 0) {
                try {
                    while (cursor.moveToNext()) {
                        ...
                        tokenAndQueue.setHoursSaved(cursor.getInt(18));
                        tokenAndQueue.setCreateDate(cursor.getString(19));
                        tokenAndQueue.setBusinessType(BusinessTypeEnum.valueOf(cursor.getString(20)));
                        tokenAndQueue.setGeoHash(cursor.getString(21));
                        tokenAndQueue.setTown(cursor.getString(22));
                        tokenAndQueue.setArea(cursor.getString(23));
                        tokenAndQueue.setDisplayImage(cursor.getString(24));
                        tokenAndQueue.setQueueUserId(cursor.getString(25));
                        tokenAndQueue.setPurchaseOrderState(cursor.getString(26) == null ? null : PurchaseOrderStateEnum.valueOf(cursor.getString(26)));
                        tokenAndQueue.setTransactionId(cursor.getString(27));
                        tokenAndQueue.setTimeSlotMessage(cursor.getString(28));
        ...
        if (cursor != null && cursor.getCount() > 0) {
            try {
                while (cursor.moveToNext()) {
                    ...
                    tokenAndQueue.setToken(cursor.getInt(12));
                    tokenAndQueue.setDisplayToken(cursor.getString(13));
                    tokenAndQueue.setQueueStatus(cursor.getString(14) == null ? null : QueueStatusEnum.valueOf(cursor.getString(14)));
                    tokenAndQueue.setServiceEndTime(cursor.getString(15));
                    tokenAndQueue.setRatingCount(cursor.getInt(16));
                    tokenAndQueue.setAverageServiceTime(cursor.getInt(17));
                    tokenAndQueue.setHoursSaved(cursor.getInt(18));
