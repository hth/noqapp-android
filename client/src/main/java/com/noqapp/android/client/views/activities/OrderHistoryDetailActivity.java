...
public class OrderHistoryDetailActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tv_coupon_discount_amt = findViewById(R.id.tv_coupon_discount_amt);
        TextView tv_coupon_discount_label = findViewById(R.id.tv_coupon_discount_label);
        ...
        tv_delivery_address.setText(StringUtils.isBlank(jsonPurchaseOrder.getUserAddressId()) ? "N/A" : jsonPurchaseOrder.getJsonUserAddress().getAddress());
