...
public class BookAppointmentActivity
    ...
    private AppointmentApiImpl appointmentApiImpl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appointmentApiImpl = new AppointmentApiImpl();
        ...
        if (BusinessTypeEnum.DO == bizStoreElastic.getBusinessType() || BusinessTypeEnum.HS == bizStoreElastic.getBusinessType()) {
            ...
            if (NoQueueClientApplication.getUserProfile().getDependents().size() > 0) {
                profileList.add(new JsonProfile().setName("Select Patient"));
                profileList.add(NoQueueClientApplication.getUserProfile());
                profileList.addAll(NoQueueClientApplication.getUserProfile().getDependents());
            } else {
                profileList.add(new JsonProfile().setName("Select Patient"));
                profileList.add(NoQueueClientApplication.getUserProfile());
            }
    ...
    private void fetchAppointments(String day) {
        ...
        if (isOnline()) {
            ...
            showProgress();
            appointmentApiImpl.scheduleForDay(
    ...
    public void showConfirmationDialog(
        ...
        btn_yes.setOnClickListener(v -> {
            ...
            showProgress();
            appointmentApiImpl.bookAppointment(UserUtils.getDeviceId(), UserUtils.getEmail(), UserUtils.getAuth(), jsonSchedule);
