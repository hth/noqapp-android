...
import com.noqapp.android.client.model.response.api.NotificationAcknowledgeApi;
...
public class NotificationAcknowledgeApiImpl {
    private final String TAG = NotificationAcknowledgeImpl.class.getSimpleName();
    private static final NotificationAcknowledgeApi NOTIFICATION_ACKNOWLEDGE_API;
    private NotificationPresenter notificationPresenter;

    public NotificationAcknowledgeApiImpl(NotificationPresenter notificationPresenter) {
        this.notificationPresenter = notificationPresenter;
    }

    static {
        NOTIFICATION_ACKNOWLEDGE_API = RetrofitClient.getClient().create(NotificationAcknowledgeApi.class);
    }

    public void notificationViewed(String did, String mail, String auth, Notification notification) {
        NOTIFICATION_ACKNOWLEDGE_API.notificationViewed(did, Constants.DEVICE_TYPE, mail, auth, notification).enqueue(new Callback<JsonResponse>() {
            @Override
