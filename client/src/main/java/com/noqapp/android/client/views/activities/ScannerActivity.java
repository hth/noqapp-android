...
public abstract class ScannerActivity extends BaseActivity implements ClientInQueuePresenter {
                        ...
                        if (contents.startsWith("https://q.noqapp.com")) {
                            try {
                                if (contents.endsWith(MessageOriginEnum.AU.name())) {
                                    ...
                                    NoQueueClientApplication.getFireBaseAnalytics().logEvent(AnalyticsEvents.EVENT_SCAN_STORE_CODE_QR_SCREEN, params);
                                }
                            } catch (Exception e) {
