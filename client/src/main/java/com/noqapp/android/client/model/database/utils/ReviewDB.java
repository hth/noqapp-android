    ...
    public static void insert(ContentValues value) {
        try {
            long successCount = dbHandler.getWritableDb().insert(
                    ...
                    null,
                    value);
            Log.d(TAG, "Data insert queueReview " + String.valueOf(successCount));
        } catch (SQLException e) {
            Log.e(TAG, "Error insert queueReview reason=" + e.getLocalizedMessage(), e);
        }
    }
