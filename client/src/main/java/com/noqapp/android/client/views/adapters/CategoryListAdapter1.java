...
public class CategoryListAdapter1  extends RecyclerView.Adapter<CategoryListAdapter1.MyViewHolder> {
    ...
    public CategoryListAdapter1(List<JsonQueue> jsonQueues, Context context, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
        final JsonQueue jsonQueue = dataSet.get(listPosition);
        holder.tv_name.setText(dataSet.get(listPosition).getDisplayName());
        holder.tv_detail.setText(PhoneFormatterUtil.formatNumber(jsonQueue.getCountryShortName(), jsonQueue.getStorePhone()));
