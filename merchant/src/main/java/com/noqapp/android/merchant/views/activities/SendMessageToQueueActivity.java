...
public class SendMessageToQueueActivity extends BaseActivity implements MessageCustomerPresenter {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_toolbar_title.setText("Message Customers in Queue");
        ...
        btn_submit.setOnClickListener((View v) -> {
            AppUtils.hideKeyBoard(SendMessageToQueueActivity.this);
            ...
            if (TextUtils.isEmpty(edt_subject.getText().toString())) {
                ...
                messageCustomerApiCalls.setReceiptInfoPresenter(SendMessageToQueueActivity.this);
                messageCustomerApiCalls.messageCustomer(
