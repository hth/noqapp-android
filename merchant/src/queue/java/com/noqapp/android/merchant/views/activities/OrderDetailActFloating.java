...
public class OrderDetailActFloating
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_discount.setOnClickListener(v -> {
            Intent in = new Intent(OrderDetailActFloating.this, CouponActivity.class);
        ...
        btn_remove_discount.setOnClickListener(v -> {
            ShowCustomDialog showDialog = new ShowCustomDialog(OrderDetailActFloating.this, true);
            showDialog.setDialogClickListener(new ShowCustomDialog.DialogClickListener() {
                ...
                public void btnPositiveClick() {
                    if (LaunchActivity.getLaunchActivity().isOnline()) {
                        ...
                        couponApiCalls.setCouponApplyRemovePresenter(OrderDetailActFloating.this);
                        ...
                        ShowAlertInformation.showNetworkDialog(OrderDetailActFloating.this);
                    }
                }
        ...
        btn_refund.setOnClickListener(v -> {
            ...
            final Dialog dialog = new Dialog(OrderDetailActFloating.this, android.R.style.Theme_Dialog);
            ...
            btn_update.setOnClickListener(v12 -> {
                ...
                AppUtils.hideKeyBoard((Activity) OrderDetailActFloating.this);
                if (!edt_random.getText().toString().equals(tv_random.getText().toString())) {
                    edt_random.setError(OrderDetailActFloating.this.getString(R.string.error_invalid_captcha));
                    new CustomToast().showToast(OrderDetailActFloating.this, getString(R.string.error_invalid_captcha));
                } else {
                    // do process
                    if (LaunchActivity.getLaunchActivity().isOnline()) {
                        showProgress();
                        ...
                        purchaseOrderApiCalls.setOrderProcessedPresenter(OrderDetailActFloating.this);
        ...
        btn_pay_partial.setOnClickListener(v -> {
            ...
            if (isProductWithoutPrice) {
                new CustomToast().showToast(OrderDetailActFloating.this, "Some product having 0 price. Please set price to them");
            } else {
                if (TextUtils.isEmpty(edt_amount.getText().toString())) {
                    new CustomToast().showToast(OrderDetailActFloating.this, "Please enter amount to pay.");
                } else {
                    if (Double.parseDouble(edt_amount.getText().toString()) * 100 > Double.parseDouble(jsonPurchaseOrder.getOrderPrice())) {
                        new CustomToast().showToast(OrderDetailActFloating.this, "Please enter amount less or equal to order amount.");
                    } else {

                        ShowCustomDialog showDialog = new ShowCustomDialog(OrderDetailActFloating.this);
                        showDialog.setDialogClickListener(new ShowCustomDialog.DialogClickListener() {
                            @Override
                            public void btnPositiveClick() {
                                if (LaunchActivity.getLaunchActivity().isOnline()) {
                                    ...
                                    PurchaseOrderApiCalls purchaseOrderApiCalls = new PurchaseOrderApiCalls();
                                    purchaseOrderApiCalls.setPaymentProcessPresenter(OrderDetailActFloating.this);
        ...
        btn_update_price.setOnClickListener(v -> {
            ...
            if (isProductWithoutPrice) {
                ...
                setProgressCancel(false);
                PurchaseOrderApiCalls purchaseOrderApiCalls = new PurchaseOrderApiCalls();
                purchaseOrderApiCalls.setModifyOrderPresenter(OrderDetailActFloating.this);
                ...
                showDialog.setDialogClickListener(new ShowCustomDialog.DialogClickListener() {
                    ...
                    public void btnPositiveClick() {
                        if (LaunchActivity.getLaunchActivity().isOnline()) {
                            ...
                            PurchaseOrderApiCalls purchaseOrderApiCalls = new PurchaseOrderApiCalls();
                            purchaseOrderApiCalls.setPaymentProcessPresenter(OrderDetailActFloating.this);
                            purchaseOrderApiCalls.setPurchaseOrderPresenter(OrderDetailActFloating.this);
        ...
        btn_print.setOnClickListener(v -> {
            ...
            if (TextUtils.isEmpty(jsonPurchaseOrder.getTransactionId())) {
                ShowCustomDialog showDialog = new ShowCustomDialog(OrderDetailActFloating.this, false);
    ...
    public void paymentProcessResponse(JsonPurchaseOrder jsonPurchaseOrder) {
        ...
        if (null != jsonPurchaseOrder) {
            if (PaymentStatusEnum.PA == jsonPurchaseOrder.getPaymentStatus() || PaymentStatusEnum.MP == jsonPurchaseOrder.getPaymentStatus()) {
                ...
                updateUI();
                new CustomToast().showToast(OrderDetailActFloating.this, "Payment updated successfully");
                if (null != updateWholeList) {
    ...
    public void orderProcessedResponse(JsonPurchaseOrderList jsonPurchaseOrderList) {
        ...
        if (null != jsonPurchaseOrderList && jsonPurchaseOrderList.getPurchaseOrders().size() > 0) {
            ...
            if (PaymentStatusEnum.PR == jsonPurchaseOrder.getPaymentStatus()) {
                updateUI();
                new CustomToast().showToast(OrderDetailActFloating.this, "Payment refund successfully");
                if (null != updateWholeList) {
                    updateWholeList.updateWholeList();
                }
            }
    ...
    public void receiptInfoResponse(Receipt receipt) {
        try {
            ...
            ReceiptGeneratorPDF receiptGeneratorPDF = new ReceiptGeneratorPDF(OrderDetailActFloating.this);
    ...
    public void couponApplyResponse(JsonPurchaseOrder jsonPurchaseOrder) {
        if (null != jsonPurchaseOrder) {
            this.jsonPurchaseOrder = jsonPurchaseOrder;
            updateUI();
            new CustomToast().showToast(OrderDetailActFloating.this, "Coupon applied successfully");
            if (null != updateWholeList) {
                updateWholeList.updateWholeList();
            }
    ...
    public void couponRemoveResponse(JsonPurchaseOrder jsonPurchaseOrder) {
        if (null != jsonPurchaseOrder) {
            this.jsonPurchaseOrder = jsonPurchaseOrder;
            updateUI();
            new CustomToast().showToast(OrderDetailActFloating.this, "Coupon removed successfully");
            if (null != updateWholeList) {
                updateWholeList.updateWholeList();
            }
            Log.e("Resp: JsonPurchaseOrder", jsonPurchaseOrder.toString());
